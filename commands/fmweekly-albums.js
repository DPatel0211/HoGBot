...
module.exports.run = async (client, message, args) => {
    require('dotenv').config();
      ...
      try {
        ...
        message.channel.send(`${message.author}'s 3x3 Album Chart of the Week (via Last.fm: https://www.last.fm/user/${associationUser.lastFMUsername})`, attachment).then(async embedMessage => {
